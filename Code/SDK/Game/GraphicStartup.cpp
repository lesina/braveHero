...
float GraphicStartup::yaw;
float GraphicStartup::pitch;
float GraphicStartup::lastX;
float GraphicStartup::lastY;
...
unsigned int GraphicStartup::texture1, GraphicStartup::texture2;
...
void GraphicStartup::init() {
    ...
    data = stbi_load("GameSDK/textures/container.jpg", &width, &height, &nrChannels, 0);
    ...
    ourShader = Shader("Code/SDK/FX/Shaders/7.3.camera.vs", "Code/SDK/FX/Shaders/7.3.camera.fs");
    ourShader.use();
...
void GraphicStartup::scroll_callback(GLFWwindow *window, double xoffset, double yoffset) {
